...
# =====================================================
# 3. Détection Multi-Attaques (SQLi, XSS, Tools)
# =====================================================
...
df_enriched = df.withColumn(
    ...
    .otherwise(col("threat_label")) # On récupère le label d'origine si aucun pattern ne match
)

# =====================================================
# 4. Extraction des dimensions temporelles
# =====================================================
...
# =====================================================
# 7. Sauvegarde HDFS (Organisation par dossiers)
# =====================================================
